...
export async function exportReportToExcel(importJobId: string): Promise<Buffer> {
  ...
  // Write KPI Table
  const kpis = [
    { name: 'Total Revenue', value: totalRev, isCurrency: true },
    { name: 'Room Revenue', value: roomRev, isCurrency: true },
    { name: 'F&B Revenue', value: foodRev, isCurrency: true },
    { name: 'Services Revenue', value: serviceRev, isCurrency: true },
    ...
    { name: 'ADR (Average Daily Rate)', value: adr, isCurrency: true },
    { name: 'RevPAR', value: revpar, isCurrency: true },
